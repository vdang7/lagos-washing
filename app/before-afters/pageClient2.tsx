    ...
    return (
        <PageLayout>
                ...
                <Section
                    ...
                    <HeaderOffset />
                    <div
                        className="absolute inset-0 size-full bg-cover bg-fixed opacity-30 hero-overlay-background-image bg-center min-[544px]:bg-left-top"
                        ></div>
                    ...
                    <SectionContainer className="relative text-center">
                        <p className="mb-2 text-xs font-semibold text-[--sectionSubtitleColor]">Lagos Pressure Washing</p>
                        <SectionTitleBigger>
                            Before and afters
                        </SectionTitleBigger>
                    ...
                    <SectionContainer>
                        <div className="mx-auto flex max-w-[31rem]">
                            ...
                            <div className="text-pretty text-sm/6 sm:!text-balance">
                                ...
                                to power wash our driveway. I am beyond
                                impressed with the results! I highly recommend
                                them. Next year, he&apos;ll do the whole house!”
                            </div>
                        </div>
                    </SectionContainer>
                </Section>
