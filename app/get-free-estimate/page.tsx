...
function StackFeatures({ className }: { className: string }) {
    return (
        <ul role="list" className={`${className} gap-y-3 text-sm/7`}>
            {features.map((item) => (
...
function Card({ className }: { className: string }) {
    return (
        <>
            <div
                className={`${className} relative isolate flex flex-col items-center justify-center overflow-hidden rounded-2xl border border-secondary-900 bg-secondary-500/10 bg-secondary-950 pb-8 pt-10`}>
                ...
                <div
                    aria-hidden="true"
                    className="absolute left-1/2 top-1/2 -z-10 -ml-16 -translate-x-1/2 -translate-y-1/2 transform-gpu blur-3xl">
                    <div
                        style={{
                            clipPath:
                ...
                />
                <StackAvatars />
                <p className="mb-4 mt-7 max-w-96 text-balance text-center text-sm font-semibold text-white">
                    Neighbors in the Triangle who gave our service a{' '}
                    <span className="text-gradient-primary">
                        5-star rating.
                    </span>
                </p>
                <div className="flex scale-[0.85] flex-wrap justify-center gap-4">
        ...
        <>
            <PageLayout hideCallToActionSection={true}>
                <Section
                    ...
                    className="pt-section relative bg-gray-50">
                    <HeaderOffset />
                    <div
                    ...
                    <div className="absolute bottom-0 h-60 w-full lg:h-[32rem]">
                        <Divider
                            className="h-14 w-full scale-x-flip scale-y-flip min-[480px]:h-20 sm:h-24 md:h-auto"
                            pathOneClassName="text-secondary-950"
                            pathThreeClassName="text-primary-400"
                            pathFourClassName="stroke-primary-100"
                        />
                        <div className="size-full bg-secondary-950"></div>
                    </div>
                    <SectionContainer className="relative">
                        <SectionColumnsTwo align="lg:items-stretch">
                            <div className="lg:flex lg:flex-col lg:pr-4 lg:pt-4">
                                <div className="lg:max-w-lg">
                                    <InteriorSubtitle className="relative mb-4 inline-flex items-center rounded-full">
                                        <GiftIcon
                                ...
                                <div className="mt-10 hidden w-full flex-grow lg:block">
                                    <div className="relative flex h-full flex-col justify-center overflow-hidden rounded-3xl border border-secondary-900 bg-secondary-950 px-6 pb-4 pt-6 shadow-2xl sm:px-12 lg:px-8 xl:px-10">
                                        <div
                                            aria-hidden="true"
                                        ...
                                        <figure className="relative isolate">
                                            ...
                                            <blockquote className="text-sm/6 font-semibold text-white xl:text-base/6">
                                                <p>
                                                    I recently hired Derek to
                                                    power wash our filthy
                                                    driveway. I am beyond
                                                    impressed with the results!
                                                    From the moment I contacted
                                                    Lagos Pressure Washing, his
                                                    team displayed utmost
                                                    professionalism. I highly
                                                    recommend them for any power
                                                    washing needs. Next year,
                                                    he&apos;ll do the whole
                                                    house!
                                                </p>
                                            </blockquote>
                                ...
                                <Card className="mt-4 hidden lg:flex" />
                            </div>
                            <div>
                                {/* <FormCalendly
                                ...
                                <FormFreeEstimate className="-mx-[1.49rem] bg-white px-6 pb-8 pt-8 ring-1 ring-inset ring-black/5 sm:mx-0 sm:rounded-2xl sm:px-8 lg:sticky lg:top-0"></FormFreeEstimate>
                                <StackFeatures className="mx-auto mt-10 flex max-w-[26.25rem] flex-wrap justify-center gap-x-8 lg:hidden" />
                                <Card className="mx-auto mt-10 max-w-[33rem] lg:hidden" />
                            </div>
                        </SectionColumnsTwo>
                    </SectionContainer>
                </Section>
